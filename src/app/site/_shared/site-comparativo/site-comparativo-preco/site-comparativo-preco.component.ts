...
@Component({
    selector: 'app-site-comparativo-preco',
    templateUrl: 'site-comparativo-preco.component.html',
    styleUrls: ['site-comparativo-preco.component.css']
})
export class SiteComparativoPrecoComponent implements OnInit {
    @Input()
    posicao: number
