...
import { CadastrosExternoComponent } from './cadastrosExterno.component';
...
@NgModule({
    declarations: [
        CadastrosExternoComponent,        CriaUsuarioExternoComponent
    ],
    exports: [CadastrosExternoComponent,        CriaUsuarioExternoComponent ],
    imports: [
        CommonModule,
        RouterModule,
        FormsModule,
...
export class CadastrosExternoModule { }